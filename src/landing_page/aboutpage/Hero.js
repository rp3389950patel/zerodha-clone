    ...
    return (
        <div className=' container'>
            <div className='row p-5 mt-5 mb-5'>
                <h2 className='fs-5 text-center'>We pioneered the discount broking model in India.
                    <br></br>Now, we are breaking ground with our technology.</h2>

            </div>
            <div className='row p-5 mt-5 border-top text-muted' style={{ lineHeight: "1.7", fontSize: "1.1rem" }}>
