        ...
        <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className='container border-top mt-5 ' >
                <div className='row  mt-5'>
                    <div className='col '>
                        <img src='assets/images/logo.svg' style={{ width: "50%" }}></img>
                        <p >© 2010 - 2025, Zerodha Broking Ltd.</p>
                        <p >All rights reserved.</p>
                        <a href='' style={{ padding: "10px" }}><i class="fa-brands fa-x-twitter"></i></a>
                        <a href='' style={{ padding: "10px" }}><i class="fa-brands fa-facebook"></i></a>
                        <a href='' style={{ padding: "10px" }}><i class="fa-brands fa-instagram"></i></a>
                        <a href='' style={{ padding: "10px" }}><i class="fa-brands fa-linkedin"></i></a><br></br><hr></hr>
                        <a href='' style={{ padding: "5px" }}><i class="fa-brands fa-youtube"></i></a>
                        <a href='' style={{ padding: "5px" }}><i class="fa-brands fa-square-whatsapp"></i></a>
                        <a href='' style={{ padding: "5px" }}><i class="fa-brands fa-telegram"></i></a>
                    </div>
                    <div className='col' >
                    ...
                    <div className='col'>
                        <p>Quick links</p>
                        <a href='' style={{ textDecoration: "none" }}>Upcoming IPOs</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}>Brokerage charges</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}>Market holidays</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}> Economic calendar</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}>Calculators</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}>Markets</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}>Sectors</a><br></br>
                        <a href='' style={{ textDecoration: "none" }}></a><br></br>
                    </div>
                </div>
                <div className='mt-5  text-muted' style={{ fontSize: "12px" }}>
                    ...
                    <a href='' style={{ textDecoration: "none" }}>Smart Online Dispute Resolution | Grievances Redressal Mechanism</a><br></br>
                    <p >Investments in securities market are subject to market risks; read all the related documents carefully before investing.</p>
                    <br></br><p >Attention investors: 1) Stock brokers can accept securities as margins from clients only by way of pledge in the depository system w.e.f September 01, 2020. 2) Update your e-mail and phone number with your stock broker / depository participant and receive OTP directly from depository on your e-mail and/or mobile number to create pledge. 3) Check your securities / MF / bonds in the consolidated account statement issued by NSDL/CDSL every month.</p>
                    <p className='text-muted'>India's largest broker based on networth as per NSE. NSE broker factsheet</p><br></br>
                ...
                <div className='mb-2' style={{ fontSize: "15px", }}>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}>NSE</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}>BSE</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}>Terms & conditions</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}>Policies & procedures</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}>Privacy policy </a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}> Disclosure</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}> For investor's attention</a>
                    <a href='' style={{ textDecoration: "none", padding: "10px" }}> Investor charter</a>
                </div>
            </div >
        </footer>
    );
